...
public:
  ...
  // the word. Words must be hashed and stored in all upper-case characters.
  // If the word not in vocabulary, add it with the appropriate
  // values, then increment the number of occurences.
